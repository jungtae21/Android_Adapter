...
public class CustomListActivity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		ListData data1 = new ListData("1-첫번째 줄", "1-두번째 줄", "1.jpg");
		listDataArray.add(data1);
		
		ListData data2 = new ListData("2-첫번째 줄", "2-두번째 줄", "2.jpg");
		listDataArray.add(data2);
		
		ListData data3 = new ListData("3-첫번째 줄", "3-두번째 줄", "3.jpg");
		listDataArray.add(data3);
		
		ListData data4 = new ListData("4-첫번째 줄", "4-두번째 줄", "4.jpg");
		listDataArray.add(data4);
		
		ListData data5 = new ListData("5-첫번째 줄", "5-두번째 줄", "5.jpg");
